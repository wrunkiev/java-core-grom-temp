...
public class Demo {
    public static void main(String[] args) {
        try {
            ...
            File file = new File(1, "file1", "doc", 140);
            File[] files1 = new File[]{file1, file2, null, null, null, file3, file4, null};
            String[] formats1 = new String[]{"txt", "jpg", "doc"};
            Storage storage1 = new Storage(1, files1, formats1, "Ukraine", 1200);
            ...
            //System.out.println(controller.delete(storage1, file));
            //System.out.println(Arrays.toString(storage1.getFiles()));
